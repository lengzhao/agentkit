...
// TurnControl is the step-level view of Control that the agent turn loop needs
// on top of agentkit.SessionControl. It lives here rather than in the root
// package because these methods are private to how the turn loop and Control
// cooperate, not part of the plugin contract.
type TurnControl interface {
	agentkit.SessionControl
	ClearTurnCancel()
