...
func (s *localFS) ListDir(ctx context.Context, path string) ([]filesystem.DirEntry, error) {
...
func (s *localFS) Grep(ctx context.Context, req filesystem.GrepRequest) (filesystem.GrepResult, error) {
	if req.Pattern == "" {
...
func (s *localFS) Find(ctx context.Context, req filesystem.FindRequest) (filesystem.FindResult, error) {
	if req.Pattern == "" {
